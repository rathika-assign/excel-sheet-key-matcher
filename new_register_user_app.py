...
if st.session_state.footer_click == "about":
    ...
    st.info(
        ...
        "The app collects your name, email, location, and role."
        "Only to track app usage and register users."
        "Data is stored securely in Google Sheets and is not shared."
        "The app does not integrate with third parties."
